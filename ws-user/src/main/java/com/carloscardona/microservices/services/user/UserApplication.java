 ...
 * 
 */
package com.carloscardona.microservices.services.user;
 ...
 * <li>The security is enabled to be covered by OAuth2 access token using the {@link EnableOAuth2Resource} annotation. The URL from where
 ...
 * configuration.</li>
 * <li>@EnableEurekaClient makes the app into both a Eureka "instance" (i.e. it registers itself) and a "client" (i.e. it can query the
 * registry to locate other services).</li>
