package com.carloscardona.microservices.portal;
 ...
 * <li>No security is defined for this application since it's the client facing UI application.</li>
 * <li>All the UI artifacts are stored under the <code>"public"</code> folder at the root.</li>
 * </ol>
 * 
 * @author candr
 */
