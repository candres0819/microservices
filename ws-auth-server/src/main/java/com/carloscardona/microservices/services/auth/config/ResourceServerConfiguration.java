...
/**
 * Since the "me" endpoint needs to be protected to be accessed only after the OAuth2 authentication is successful; the server also becomes
 * a resource server.
 * 
 * @author anilallewar
 *
...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
	...
	/**
	 * Configure security to allow access to the /me endpoint only if the OAuth authorization returns "read" scope.<br>
	 * <br>
	 * 
	 * If you look at
	 ...
	 * to check that by default the authorization server allows "read" scope only.
	 */
	@Override
